...
// Automatically monitors ESPN Live Draft Rooms and relays picks to Fantasy Drafter on http://127.0.0.1:8517

(function() {
  function isDraftRoom() {
    return window.location.href.includes('/draft') ||
           document.querySelector('.draft-table, .pick-history, [data-testid="draft-row"], .draft-recent-pick, .draft-cell') !== null;
  }
