...
def fetch_and_save_csv(
    url: str, description_or_path: str | None = None, output_dir: str = "data"
) -> str:
    ...
    if description_or_path and (
        description_or_path.endswith(".csv")
        or os.path.sep in description_or_path
        or "/" in description_or_path
    ):
