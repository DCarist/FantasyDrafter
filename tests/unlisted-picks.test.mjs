...
const customPickWithTeam = {
  overall: 6,
  playerId: null,
  customName: 'Tyler Warren',
  customPos: 'TE',
  customTeam: 'IND',
};
...
eq(
  normalPickStr,
  '#4 (1.04) Doug: James Cook III (RB · BUF)',
  'Formats standard pick for clipboard',
);
...
eq(
  keeperPickStr,
  '#93 (8.09) Doug: Brock Bowers (TE · LV) [Keeper]',
  'Formats keeper pick with [Keeper] attribution',
);
...
eq(
  tradedPickStr,
  '#25 (3.01) Cody: James Cook III (RB · BUF)',
  'Resolves traded pick recipient team name',
);
...
eq(
  resCopied,
  '#4 (1.04) Doug: James Cook III (RB · BUF)',
  'copyLastDraftPick returns formatted last pick',
);
eq(
  copiedClipboardText,
  '#4 (1.04) Doug: James Cook III (RB · BUF)',
  'Puts last pick onto clipboard',
);
...
eq(
  copiedClipboardText,
  '#4 (1.04) Doug: James Cook III (RB · BUF)',
  'Ctrl+C with nothing selected copies last draft pick',
);
